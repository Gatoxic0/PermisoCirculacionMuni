    ...
    try {
        ...
        if ($stmtCheck->fetchColumn() > 0) {
            ...
            if (!empty($_POST['email'])) {
                $subject = "Confirmación de Solicitud de Renovación de Permiso de Circulación";
                $htmlMessage = "Estimado/a {$_POST['nombre']},<br><br>";
                $htmlMessage .= "Su solicitud de renovación de permiso de circulación ha sido recibida exitosamente.<br><br>";
                $htmlMessage .= "<strong>Detalles de la solicitud:</strong><br>";
                $htmlMessage .= "- Patente del vehículo: {$_POST['placa_patente']}<br>";
                $htmlMessage .= "- Comuna: {$_POST['comuna']}<br>";
